...
public class Arm extends SubsystemBase {
  ...
  private double armExtensionGearRatio = 5./1.;
  private double armExtensionGearRadius = 0.477; //in inches
  private double armRotationGearRatio = 200./1.;
  ...
  public double getRotationArmPosition() {
    return m_rotationArm.getEncoder().getPosition()
    * 360 * armRotationGearRatio;
  }

  public double getExtensionArmPosition() {
    return m_extendArm.getEncoder().getPosition()
    * armExtensionGearRadius
    * 2 * Math.PI
